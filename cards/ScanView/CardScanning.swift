...
enum CardScanningEngineFactory {
	static var currentEngineID: String { CardScanningEngineID.scanbot }

	@MainActor
	static func make() -> any CardScanningEngine {
		#if os(iOS)
		ScanbotCardScanningEngine()
		#else
		UnavailableCardScanningEngine(engineID: CardScanningEngineID.scanbot)
		#endif
	}
}
